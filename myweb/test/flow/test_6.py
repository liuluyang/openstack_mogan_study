...
class CallJoe(task.Task):
    ...
    def revert(self, joe_number, result, flow_failures  ,*args, **kwargs):
        print result
        print flow_failures
        for i in flow_failures.values():
            print i
...
class CallSuzzie(task.Task):
    ...
    def revert(self, result, flow_failures,suzzie_number ,*args, **kwargs):
        print suzzie_number
        print result
